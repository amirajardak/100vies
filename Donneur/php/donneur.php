...
/* ============================= CAMPAGNES ============================= */
$campagnes = mysqli_query($conn, "SELECT * FROM campagne ORDER BY date_deb_cmp DESC");

/* ============================= TEMOIGNAGES ============================= */
$infos = mysqli_query($conn, "SELECT * FROM temoignages ORDER BY created_at DESC");
...
<title>100Vie – Fil d’actualité</title>
</head>
...
<script src="../js/donneur.js"></script>
